        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Questions_QuestionType", "[QuestionType] IN (1, 2, 3, 4, 5, 6)");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Quizzes_PositiveDuration", "[Duration] > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Answers_Id_QuestionId", x => new { x.Id, x.QuestionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_QuizQuestions_PositiveOrder", "[Order] >= 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_UserAnswers_Response", "([AnswerId] IS NOT NULL AND [ResponseText] IS NULL)\r\nOR ([AnswerId] IS NULL AND [ResponseText] IS NOT NULL\r\n    AND LEN(LTRIM(RTRIM([ResponseText]))) > 0)");
                    table.ForeignKey(
                        name: "FK_UserAnswers_Answers_AnswerId_QuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAnswers_AnswerId_QuestionId",
                table: "UserAnswers",
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[AnswerId] IS NULL");

            migrationBuilder.CreateIndex(
                name: "IX_UserAnswers_QuizAttemptId_QuestionId_AnswerId",
                table: "UserAnswers",
